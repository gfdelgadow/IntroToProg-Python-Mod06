...
# <GDW>,<8.17.2021>,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def add_data_to_list(task, priority, list_of_rows):
        """ Appends inputted task and priority to table

        :param task: (string) with name of task be added
    ...
    def remove_data_from_list(task, list_of_rows):
        """ Removes inputted task from table
    ...
    def write_data_to_file(file_name, list_of_rows):
        """ Saves current dictionary table to file

        :param file_name: (string) Name of file being written to
        :param list_of_rows: (list) of dictionary rows
        :return: list_of_rows: (list) of dictionary rows
        """
...
class IO:
    ...
    def input_new_task_and_priority():
        """ Input new task to add to list

        :return: task: (string) with name of task be added
        :return: priority: (string) with priority of task
        """
    ...
    def input_task_to_remove():
        """ Input existing task to be removed from list

        :return: task: (string) with name of task be removed
        """
        task = str(input("Enter the name of the task you'd like removed: "))
        return task
